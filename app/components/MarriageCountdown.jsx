        ...
        <>
            <div className="bg-[url('/assets/thingtoknow.png')] bg-cover bg-no-repeat">
                <div className="lg:h-150 md:h-100 h-110">
                    <h2 className="lg:text-[40px] text-2xl text-center text-white lg:pt-42 pt-12">The countdown begins<br />
                        {timeLeft.days}D {timeLeft.hours}H {timeLeft.minutes}M</h2>
                    <p className="lg:text-[22px] text-[16px] text-[#DEE6FF] mt-4 text-center lg:px-100 md:px-25 px-10">
                    ...
                    <p className="lg:text-[26px] text-xl text-[#DEE6FF] mt-26 text-center">
                        © Invite Arc 2026 </p>
                </div>
            </div>
        </>
